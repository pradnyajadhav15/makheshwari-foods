...
export default function WhatsAppButton() {
  ...
  return (
    <a href={`https://wa.me/${wa}?text=Hi%2C%20I%20have%20a%20question%20about%20Makheshwari%20Makhana`} target="_blank" rel="noopener noreferrer" aria-label="Message us on WhatsApp" className="fixed bottom-6 right-6 z-50 w-14 h-14 rounded-full bg-[#25D366] flex items-center justify-center shadow-[0_10px_30px_-6px_rgba(0,0,0,0.4)] transition-transform duration-300 hover:scale-110">
