...
export default function Error({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  ...
  return (
    <section className="wrap-mid section-lg text-center">
      ...
      <p className="lede text-ink/65 mt-6">We have been told about it. Try again in a moment.</p>

      <p className="text-ink/60 body-text mt-4 max-w-lg mx-auto">
      ...
      {error.digest && (
        <p className="text-ink/35 text-[0.62rem] tracking-tracksm uppercase mt-12">
