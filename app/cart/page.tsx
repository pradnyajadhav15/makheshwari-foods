...
export default function CartPage() {
  ...
  if (count === 0) {
    return (
      <section className="wrap section-lg text-center">
        ...
        <p className="lede text-ink/55 mt-5 mb-9">Nothing in here yet.</p>
  ...
  return (
    <section className="wrap section">
      ...
      <p className="text-ink/50 text-sm font-light mt-3 mb-9">
      ...
      <div className="grid lg:grid-cols-[1.6fr_1fr] gap-8 lg:gap-12 items-start">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex justify-between gap-3">
                  <div className="min-w-0">
                    <Link
                      href={`/shop/makhana/${p.slug}`}
                      className="font-display text-lg sm:text-xl text-ink hover:text-gold transition"
                    >
                      {p.name}
                    </Link>
                ...
                <div className="flex items-center justify-between gap-3 mt-4">
                  <div className="flex items-center border border-ink/18 rounded-full">
                    <button
                      ...
                      className="w-10 h-10 flex items-center justify-center text-ink/60 hover:text-ink transition"
                    >
                  ...
                  <button
                    ...
                    className="text-ink/40 text-[0.64rem] tracking-tracksm uppercase hover:text-peri transition py-2"
                  >
                    Remove
                  </button>
                </div>
        ...
        <div className="lg:sticky lg:top-28">
          <div className="border border-ink/12 bg-paper p-6 sm:p-7">
            ...
            <Link
              href="/shop"
              className="block text-center text-ink/50 text-[0.66rem] tracking-tracksm uppercase mt-5 py-2 hover:text-gold transition"
            >
              Continue shopping
            </Link>
          </div>
